...
// /___/   /\     Timestamp : 01/30/2026 20:20:04
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family spartan3e -w C:/EE533/lab3/lab3_new/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   AND3B2 XLXI_12 (.I0(XLXN_32), 
                   .I1(XLXN_31), 
                   .I2(fiforead), 
                   .O(XLXN_28));
   OR2 XLXI_13 (.I0(XLXN_15), 
                .I1(XLXN_16), 
                .O(XLXN_18));
   AND2B1 XLXI_14 (.I0(XLXN_49), 
                   .I1(XLXN_18), 
                   .O(XLXN_36));
   dual9Bmem XLXI_15 (.addra(waddr[7:0]), 
                      .addrb(raddr[7:0]), 
                      .clka(clk), 
                      .clkb(clk), 
                      .dina(in_fifo0[71:0]), 
